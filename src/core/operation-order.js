...
const RELEASE_OPERATION_RANK=Object.freeze(new Map([
  ...
  ["release-approval-precondition",-98.2],
  ["release-approval-base-precondition",-98.15],
  ["release-publication-precondition",-98.1],
  ...
  ["release-pull-request-merge",26],
  ["release-publication-workflow",27],
  ["release-program-manifest",30],
  ["release-program-manifest-set",30.5],
